...
public class CustomAdapterSH extends RecyclerView.Adapter<CustomAdapterSH.MyViewHolder> {
    Context context;
    Activity activity;
    ...
    public CustomAdapterSH(Activity activity, Context context, ArrayList station_id, ArrayList station_number,
